...
const StenoChat = ({ id = "default", origin, url = "https://chat.steno.ai", position = "right" }) => {
    (0, react_1.useEffect)(() => {
        // check if the script is already loaded
        if (document.getElementById('steno-chat') || document.getElementById('chat-iframe')) {
            return;
        }
        const script = document.createElement('script');
        script.id = 'steno-chat';
        script.type = "text/javascript";
        script.src = 'https://cdn.jsdelivr.net/gh/aisteno/embed@1.1.3/steno-chat.js';
        if (id) {
